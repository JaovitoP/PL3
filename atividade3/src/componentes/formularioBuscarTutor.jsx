...
export default function FormularioAtualizarPet(props) {
  ...
  const [pets, setPets] = useState([
    new Pet("Didi", "Vira-lata"),
    new Pet("Floco", "Poodle"),
    new Pet("Pituco", "Golden retriever"),
    new Pet("Titi", "Poodle"),
  ]);
            ...
            <form className="row g-3" onSubmit={handleSubmit}>
              ...
              <div className="input-group mb-3">
                <input
                  ...
                  value={editingPet.raça}
                  aria-label="Raça Pet1"
                  aria-describedby="basic-addon1"
                  disabled={!edit}
                  onChange={(e) => handleInputChange(e, "raça")}
                />
              </div>
              ...
              <div className="input-group mb-3">
                <a href="">
                  <button
                    ...
                    title="Clique aqui para excluir o pet"
                ...
                <a href="">
                  <button
                    className="input-group-text"
                    title="Clique aqui para editar ou salvar edições"
